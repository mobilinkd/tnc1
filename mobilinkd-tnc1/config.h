...
#define AUDIO_OUTPUT_ATTEN_DDR DDRB
#define AUDIO_OUTPUT_ATTEN_PORT PORTB
#define AUDIO_OUTPUT_ATTEN_PIN PIN0

#define BATTERY_LEVEL_DDR DDRC
#define BATTERY_LEVEL_PORT PORTC
#define BATTERY_LEVEL_PIN PIN2

#define BATTERY_ENABLE_DDR DDRC
#define BATTERY_ENABLE_PORT PORTC
#define BATTERY_ENABLE_PIN PIN3
